...
/* WEBPACK VAR INJECTION */(function(global) {/* harmony import */ var nativejs_select__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! nativejs-select */ "./node_modules/nativejs-select/build/nativejs-select.min.js");
...
jquery__WEBPACK_IMPORTED_MODULE_1___default()(document).ready(function () {
  jquery__WEBPACK_IMPORTED_MODULE_1___default()('.menu__button--open').click(function (event) {
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.menu__wrapper').toggleClass('active');
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.menu__wrapper').slideToggle(300);
  });
  jquery__WEBPACK_IMPORTED_MODULE_1___default()('.menu__button--close').click(function (event) {
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.menu__wrapper').toggleClass('none');
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.menu__wrapper').slideToggle(300);
  });
